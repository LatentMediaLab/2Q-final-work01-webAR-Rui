...
export const APP_CONFIG = {
  ...
  performance: {
    displayPostCounts: [10, 20, 35, 40, 45, 50] as const,
    defaultDisplayPosts: 45,
    maxPosts: 50,
    maxActiveVideos: 1,
  ...
  fallback: {
    ...
    layout: {
      radius: 4,
      horizontalAngleDegrees: 120,
      verticalAngleDegrees: 50,
      columns: 9,
      rows: 5,
      cardScale: 1,
      imageScaleMultiplier: 1.75,
      textCharactersPerLine: 30,
      horizontalJitterDegrees: 5,
      verticalJitterDegrees: 4,
      verticalOffset: 0.15,
    },
    defaultScale: 1,
    minScale: 0.65,
